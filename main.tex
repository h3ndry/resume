...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
    \tableentry{LANGUAGES}{TypeScript, JavaScript, C\#, C++, React, .NET Core, Python, CSS, HTML, CSS}{spaceafter}
	\tableentry{TECHNOLOGIES}{Javascript, Python, HTML, CSS,}{}
	\tableentry{}{Microsoft Windows}{}
	\tableentry{}{Computer Hardware \& Support}{spaceafter}
	\tableentry{DATABASES}{Perl, Unix, \LaTeX}{spaceafter}
\end{supertabular}
...
\jobentry
	{Kriterion} % Company name
	{Current, from Jan 1995} % Duration
	{FT} % FT/PT (full time or part time)
    {Software Engineer (FullStack)} % Job title
    {
        \begin{itemize}
            \item As part of this promotion, I began conducting nuclear and subatomic
            \item research in the Anomalous Materials department. My team and I are
            \item particularly interested in dimensionality and its interaction with
            \item spacetime. The focus is on practical outcomes and applications in
            \item teleportation and communication with distal locations.
        \end{itemize}
