...
\begin{minipage}[t]{0.5\textwidth} % 50% of the page for the skills bar chart
    ...
    \begin{tabular}{ r l}
        \colorbox{black!30}{Languages} & \cvtag{TypeScript} \cvtag{CSS} \cvtag{SASS} \cvtag{MySql} \cvtag{C\#}  \vspace{0.3em} \\
        \colorbox{black!30}{Tools} & \cvtag{Neovim} \cvtag{Arch Linux} \cvtag{LSP} \cvtag{Pycharm} \cvtag{Postman}  \vspace{0.3em} \\
        \colorbox{black!30}{Design} & cell2 \vspace{0.3em} \\
        \colorbox{black!30}{Databases} & cell2 \vspace{0.3em} \\
        \colorbox{black!30}{Databases} & cell2 \\
    \end{tabular}
